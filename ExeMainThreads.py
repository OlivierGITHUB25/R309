...
def TestDownload(nb):
    ...
    print(f"Vitesse moyenne pour 10 Multiprocessing {moyenneMP}s. Vitesse moyenne pour 10 poolThreads {moyenneTHP}s. Vitesse moyenne pour 10 Threads {moyenneTH}s. ")


if __name__ == '__main__':
    sys.exit(TestDownload(10))